...
const en = {
  ...
  "pages.projects.clickthrough": "more projects",
...
const nl: Record<keyof typeof en, string> = {
  ...
  "pages.about.sports.description1": "Mijn favoriete hobby. Dat was het twintig jaar geleden al, en dat zal het over twintig jaar nog steeds zijn. Sport is het enige wat me nooit verveelt, al vereist dat wel een pivot om de paar jaar.",
  "pages.about.sports.description2": "Ik groeide op met voetballen en tennissen, maar mijn voorkeur was al snel duidelijk. Al snel moest tennis plaatsmaken voor de prioriteiten van een puberjongen: geld verdienen, een sociaal leven en een vriendin. Dat bleef zo totdat ik naar de universiteit ging, waar ik tennis opnieuw ontdekte. In die jaren draaide mijn hele sociale leven om tennis, en ik had het geweldig naar mijn zin. Ik bracht veel tijd door op de banen en werd er best goed in — totdat het ongeluk toesloeg.",
  "pages.about.sports.description3": "Een scherpe pijn in mijn pols was de reden dat ik meer dan een half jaar niet kon spelen. Maar dat weerhield me er niet van een nieuwe sportieve uitdaging aan te gaan. Ik stuitte op een video van Average Rob waarin hij een van de zwaarste uitdagingen in de sport aanpakt: een Ironman triathlon. Ik was meteen verkocht. Ik leerde mezelf zwemmen, stofte mijn racefiets af die al zes jaar stond te verstoffen, en ging aan de slag. Aan het einde van die zomer, slechts vier maanden na het blessure, deed ik mijn eerste halve triathlon.",
  "pages.writing.title": "schrijfsels.",
  "pages.writing.clickthrough": "meer schrijfsels",
  "pages.projects.title": "projecten.",
  "pages.projects.clickthrough": "meer projecten",
